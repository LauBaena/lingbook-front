...
export const useVideosStore = defineStore("videos", {
    ...
    actions: {
        ...
        async fetchUserVideos(id_usuari) {
            ...
            const filtradoArray = data.filter((obj, index, self) =>
                index === self.findIndex((o) => o.id_video === obj.id_video)
            );

            this.modify_data(filtradoArray, "0")
        ...
        async fetchLastUserVideos(id_usuari) {
            ...
            this.lastTeacherVideos = filtradoArray;
        },
